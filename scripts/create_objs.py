...
person3 = User(username='Oleg_1023', password='1111', first_name='Oleg', last_name='Mat', card_number='5375414135549120', phone='0971228815', email='oleg@gmail.com')
