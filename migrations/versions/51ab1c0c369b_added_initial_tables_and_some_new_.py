"""Added initial tables and some new changes

Revision ID: 51ab1c0c369b
Revises: 
Create Date: 2022-11-22 21:05:40.982639
...
def upgrade() -> None:
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('group_id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('UNACCEPTED', 'ACCEPTED', 'BANNED', name='userstatus'), nullable=False),
